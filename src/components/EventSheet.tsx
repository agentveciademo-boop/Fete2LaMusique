  ...
  return (
    ...
    >
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-background rounded-t-2xl max-h-[95dvh] flex flex-col outline-none">
          <div className="mx-auto mt-3 mb-2 w-12 h-1.5 rounded-full bg-muted shrink-0" />
