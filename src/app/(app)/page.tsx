...
export default function AffluencePage() {
  ...
  return (
    <div className="absolute inset-0">
      ...
      {/* Sélecteur de langue — coin haut-droit, au-dessus du bandeau titre */}
      <div className="pointer-events-auto absolute right-4 z-20"
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 z-10 px-4 pt-3"
        ...
        <div className="pointer-events-auto rounded-2xl border border-white/10 px-4 py-3 pr-16 backdrop-blur-xl"
