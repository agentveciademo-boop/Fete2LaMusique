...
// Écran · Carte nuit (`/carte`) — map-first, pins goutte multi-genres, scrubber temporel, peek sheet.
// L'accueil `/` est désormais l'écran Affluence ; la carte vit sous /carte.
